...
Note: the only instantiation of the VendingMachine instance is done via tests and I have not utilised the main class (which can also be used to demonstrate operations for the vending machine).
